...
# BiLSTM
CUDA_VISIBLE_DEVICES=1 python main.py --dataset 'Twitter' \
...
# EANN_Text
CUDA_VISIBLE_DEVICES=3 python main.py --dataset 'Twitter' \
--use_preference_map False --use_pattern_based_model True --use_fact_based_model False \
...
# BERT_Emo
CUDA_VISIBLE_DEVICES=2 python main.py --dataset 'Twitter' \
--use_preference_map False --use_pattern_based_model True --use_fact_based_model False \
